            ...
            <div className="flex space-x-2 mb-2">
                ...
                <div className="flex items-center space-x-2">
                    <input
                        ...
                        value={allDay && dueDate ? dueDate.split('T')[0] : dueDate ? dueDate.slice(0, 16) : ''} // Format for input
                        onChange={(e) => {
              ...
              {allDay ? dueDate.split('T')[0] : new Date(dueDate).toLocaleString()}
            </span>
                    )}
                </div>
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                if (isAllDay && dueDate) {
                                    ...
                                    // Preserve date but reset time to current or default
                                    const dateOnly = dueDate.split('T')[0];
                                    const now = new Date();
                ...
                <div className="flex space-x-4">
                    <button
                        ...
                        onClick={() => {
                            ...
                            setAllDay(true); // Set allDay to true for "Today"
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            setAllDay(true); // Set allDay to true for "Tomorrow"
